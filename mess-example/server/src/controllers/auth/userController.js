...
export const registerUser = asyncHandler(async (req, res) => {
  ...
  if (user) {
    const { _id, name, email, role, photo, bio, isVerified, theme, friendRequests, lastSeen, friends } = user
...
export const loginUser = asyncHandler(async (req, res) => {
  ...
  if (userExists && isMatch) {
    const { _id, name, email, role, photo, bio, isVerified, theme, friendRequests, lastSeen, friends } = userExists
