...
function Profile() {
  ...
  return (
    <div className="px-4 pb-8 w-[90%]">
      <h3 className={`pt-6 pb-8 flex justify-center text-3xl font-black ${gradientText} dark:text-white`}>
        My Profile
      </h3>
      ...
      <div className="flex flex-col">
        ...
        >
          <div className="mb-2">
            <label htmlFor="name" className={`text-lg font-semibold ${gradientText} dark:text-slate-200`}>
              Full Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="bio" className={`text-lg font-semibold ${gradientText} dark:text-slate-200`}>
              Bio
            </label>
            <textarea
              name="bio"
        ...
        >
          <div className="flex gap-2">
            <div>
              <label htmlFor="oldPassword" className={`text-lg font-semibold ${gradientText} dark:text-slate-200`}>
                Old Password
              </label>
              <input
                type="password"
            ...
            <div>
              <label htmlFor="newPassword" className={`text-lg font-semibold ${gradientText} dark:text-slate-200`}>
                New Password
              </label>
              <input
                type="password"
