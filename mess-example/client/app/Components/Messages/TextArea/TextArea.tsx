  ...
  return (
    ...
    >
      <div className="relative flex-1">
        <textarea
          className="textarea w-full px-3 sm:px-4 py-2 sm:py-3 border-2 rounded-[30px] border-white bg-[#F6F5F9] dark:bg-[#262626] dark:text-gray-100 text-[#12181b] dark:border-[#3C3C3C]/65 
        ...
        <button
          type="button"
          className="absolute top-[22px] right-3 text-[#aaa] translate-y-[-50%] text-xl sm:text-2xl"
      ...
      <button
        ...
        className="px-3 sm:px-4 self-start py-2 w-10 h-10 sm:w-12 sm:h-12 bg-[#7263f3] text-white rounded-full ml-2 shadow-sm"
      >
        {send}
      </button>
      {toggleEmoji && (
        <div
          ref={emojieElemRef}
          className="absolute right-0 bottom-[72px] z-10 scale-75 sm:scale-100 origin-bottom-right"
        >
          <EmojiPicker
