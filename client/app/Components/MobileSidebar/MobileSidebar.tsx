...
function MobileSidebar({ onClose, onCreateGroup }: MobileSidebarProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50">
        ...
        {activeView === "all-chats" && (
          <div className="mt-4">
            <div className="flex items-center justify-between px-4">
              <h4 className={`grid grid-cols-[22px_1fr] items-center font-bold ${gradientText} dark:text-slate-200`}>
                {chat}
                <span>All Chats</span>
              </h4>
              <button
                ...
                onClick={() => {
                  if (onCreateGroup) {
                    ...
                    onClose(); // Close sidebar if no group handler provided
                  }
                }}
                  ...
                  return (
                    <ChatItem
                      ...
                      user={{
                        ...
                        photo: "/logo.png",
                        // Add all required IUser properties
                        bio: "",
                        createdAt: "",
                        email: "",
                        friendRequests: [],
      ...
      {/* Group Chat Creation Modal is now handled by the parent component */}
    </div>
  )
}
